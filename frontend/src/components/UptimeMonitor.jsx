      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
          ...
          <button
            ...
            className={`p-3 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-400 hover:bg-blue-500/20 hover:border-blue-500/40 transition-all ${
        ...
        <div className="bg-gradient-to-br from-slate-900/50 to-blue-900/30 backdrop-blur-xl rounded-2xl p-6 mb-8 border border-blue-500/20 shadow-xl">
          ...
          <form onSubmit={handleAddService} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <input
                ...
                className="px-4 py-3 bg-slate-900/50 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
                required
              />
              <input
                type="url"
              ...
              <div className="flex gap-2">
                <select
                  ...
                  className="flex-1 px-4 py-3 bg-slate-900/50 border border-slate-700 rounded-xl text-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.length === 0 ? (
            ...
            services.map((service) => (
              <div
                key={service._id}
                className="bg-gradient-to-br from-slate-900/80 to-blue-900/40 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50 hover:border-blue-500/50 transition-all shadow-lg hover:shadow-blue-500/10"
              >
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-slate-400 text-sm truncate bg-slate-900/50 px-3 py-2 rounded-lg">{service.url}</p>

                  <div className="grid grid-cols-2 gap-3 pt-2">
                    <div className="bg-slate-900/50 border border-slate-700/50 rounded-lg p-3">
                      <div className="text-slate-500 text-xs mb-1 uppercase tracking-wide">Response Time</div>
                    ...
                    <div className="bg-slate-900/50 border border-slate-700/50 rounded-lg p-3">
                      <div className="text-slate-500 text-xs mb-1 uppercase tracking-wide">Uptime</div>
                      <div className="text-white font-bold text-sm">
                    ...
                    <div className="bg-slate-900/50 border border-slate-700/50 rounded-lg p-3">
                      <div className="text-slate-500 text-xs mb-1 uppercase tracking-wide">Ping Interval</div>
                    ...
                    <div className="bg-slate-900/50 border border-slate-700/50 rounded-lg p-3">
                      <div className="text-slate-500 text-xs mb-1 uppercase tracking-wide">Last Ping</div>
                      <div className="text-white font-bold text-sm">
                        {service.lastPing
        ...
        <footer className="mt-12 text-center pb-6">
          <div className="bg-gradient-to-br from-slate-900/50 to-blue-900/30 backdrop-blur-xl rounded-2xl p-6 border border-blue-500/20">
            <p className="text-slate-400 text-sm">
              Built with ❤️ by{' '}
              <span className="text-transparent bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text font-bold">Mr Frank</span>
            </p>
            <div className="flex items-center justify-center gap-6 mt-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-500 hover:text-blue-400 transition-colors text-sm group"
              >
